    ...
    <div class="col-lg-8 col-md-8 mb-4">
        <form method="post" action="{{ route('types.update', $type->id) }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $type->name ?? old('name') ?? '' }}" required autocomplete="name" autofocus>
