...
<div class="row">
    <div class="col-lg-12 col-md-8 mb-4">
        <h6 class="float-left">UPDATE LINK</h6>
    </div>
</div>
    ...
    <div class="col-lg-8 col-md-8 mb-4">
        <form method="post" action="{{ route('links.update', $link->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $link->title ?? old('title') }}" required autofocus>
